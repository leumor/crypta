...
val signApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("sitePublisherStagedBundleForSigning")
...
val verifyApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("sitePublisherStagedBundleForVerification")
      .withPathSensitivity(PathSensitivity.RELATIVE)
    doFirst {
...
tasks.named<Test>("test") {
  ...
  inputs
    .dir(stageAppDir)
    .withPropertyName("sitePublisherStagedBundle")
    .withPathSensitivity(PathSensitivity.RELATIVE)
  inputs.property("sitePublisherAppVersion", project.version.toString())
  systemProperty("sitePublisher.stageDir", stageAppDir.get().asFile.absolutePath)
  systemProperty("sitePublisher.appVersion", project.version.toString())
}
