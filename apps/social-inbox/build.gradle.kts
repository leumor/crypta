...
val launcherRelativePath = "bin/social-inbox.sh"
...
val signApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("socialInboxStagedBundleForSigning")
...
val verifyApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("socialInboxStagedBundleForVerification")
      .withPathSensitivity(PathSensitivity.RELATIVE)
    doFirst {
...
tasks.named<Test>("test") {
  ...
  inputs
    .dir(stageAppDir)
    .withPropertyName("socialInboxStagedBundle")
    .withPathSensitivity(PathSensitivity.RELATIVE)
  inputs.property("socialInboxAppVersion", project.version.toString())
  systemProperty("socialInbox.stageDir", stageAppDir.get().asFile.absolutePath)
  systemProperty("socialInbox.appVersion", project.version.toString())
}
