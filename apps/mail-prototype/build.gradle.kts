...
val appDisplayName = "Mail Prototype"
...
val launcherRelativePath = "bin/mail-prototype.sh"
...
dependencies {
  ...
  testImplementation(project(":platform-appvault"))
...
val signApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("mailPrototypeStagedBundleForSigning")
...
val verifyApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("mailPrototypeStagedBundleForVerification")
      .withPathSensitivity(PathSensitivity.RELATIVE)
    doFirst {
...
tasks.named<Test>("test") {
  ...
  inputs
    .dir(stageAppDir)
    .withPropertyName("mailPrototypeStagedBundle")
    .withPathSensitivity(PathSensitivity.RELATIVE)
  inputs.property("mailPrototypeAppVersion", project.version.toString())
  systemProperty("mailPrototype.stageDir", stageAppDir.get().asFile.absolutePath)
  systemProperty("mailPrototype.appVersion", project.version.toString())
}
