...
val appDisplayName = "Profile Publisher"
val appId = "profile-publisher"
...
val launcherRelativePath = "bin/profile-publisher.sh"
...
val signApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("profilePublisherStagedBundleForSigning")
...
val verifyApp by
  tasks.registering(JavaExec::class) {
    ...
    inputs
      .dir(stageAppDir)
      .withPropertyName("profilePublisherStagedBundleForVerification")
      .withPathSensitivity(PathSensitivity.RELATIVE)
    doFirst {
...
tasks.named<Test>("test") {
  ...
  inputs
    .dir(stageAppDir)
    .withPropertyName("profilePublisherStagedBundle")
    .withPathSensitivity(PathSensitivity.RELATIVE)
  inputs.property("profilePublisherAppVersion", project.version.toString())
  systemProperty("profilePublisher.stageDir", stageAppDir.get().asFile.absolutePath)
  systemProperty("profilePublisher.appVersion", project.version.toString())
}
